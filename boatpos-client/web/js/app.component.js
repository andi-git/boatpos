System.register(['angular2/core', "./boat.service", "./config.service", 'angular2/http', "./boats.component", "./commitments.component", "./commitment.service", "./promotionBefore.service", "./promotionsBefore.component", "./boatCount.component"], function(exports_1) {
    ...
    var core_1, boat_service_1, config_service_1, http_1, boats_component_1, commitments_component_1, commitment_service_1, promotionBefore_service_1, promotionsBefore_component_1, boatCount_component_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
            ...
            AppComponent = (function () {
                ...
                AppComponent = __decorate([
                    core_1.Component({
                        ...
                        directives: [boats_component_1.BoatsComponent, commitments_component_1.CommitmentsComponent, promotionsBefore_component_1.PromotionsBeforeComponent, boatCount_component_1.BoatCountComponent],
