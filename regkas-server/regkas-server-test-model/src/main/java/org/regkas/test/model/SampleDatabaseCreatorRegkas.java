...
public class SampleDatabaseCreatorRegkas implements SampleDatabaseCreator {
    ...
    public void fillDatabase(EntityManager em) throws Exception {
        ...
        ReceiptTypeEntity receiptType10 = new ReceiptTypeTagEntity(null, null, true, 10, "", "", "Tages-Beleg", false);
        ReceiptEntity receipt0 = new ReceiptEntity(null, null, "2015-0000000", LocalDateTime.of(2015, 7, 1, 12, 00, 00), "12345", "sign", company, cashBox1, user1, receiptType1, PaymentMethod.CASH, new ArrayList<>(), "", new BigDecimal("0.00"), "R1-AT0", "jws123", "xxx.jws123.sss", true);
