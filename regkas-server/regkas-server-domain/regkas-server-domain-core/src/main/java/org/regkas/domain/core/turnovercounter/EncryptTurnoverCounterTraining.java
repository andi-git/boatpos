...
@ApplicationScoped
public class EncryptTurnoverCounterTraining implements EncryptTurnoverCounter {
    ...
    public EncryptedTurnoverValue encryptTurnoverCounter(ReceiptId receiptId, CashBox cashBox) {
        return new EncryptedTurnoverValue(encoding.base64Encode("TRA".getBytes(), false));
    }
}
