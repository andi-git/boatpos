            ...
            Printer = (function () {
                ...
                Printer.prototype.printJournal = function (journalReport) {
                    ...
                    if (lang_1.isPresent(journalReport)) {
                        ...
                        request = this.printLine(builder, request, 1, 1, "left", true, false, this.pp.ppFixLength("SUMME:", 18, prettyprinter_1.Align.LEFT) + this.pp.ppFixLength(String(sum_1), 10, prettyprinter_1.Align.RIGHT));
                        request = this.blankLine(builder, request);
                        sum_1 = 0;
                        ...
                        journalReport.journalReportItems.forEach(function (jri) {
                            ...
                            sum_1 += (jri.pricePaidBeforeCash + jri.pricePaidAfterCash);
                        });
                        request = this.printLine(builder, request, 1, 1, "left", true, false, this.pp.ppFixLength("SUMME:", 18, prettyprinter_1.Align.LEFT) + this.pp.ppFixLength(this.pp.ppPrice(sum_1), 10, prettyprinter_1.Align.RIGHT));
                        request = this.blankLine(builder, request);
                        sum_1 = 0;
                        ...
                        journalReport.journalReportItems.forEach(function (jri) {
                            ...
                            sum_1 += (jri.pricePaidBeforeCard + jri.pricePaidAfterCard);
                        });
                        request = this.printLine(builder, request, 1, 1, "left", true, false, this.pp.ppFixLength("SUMME:", 18, prettyprinter_1.Align.LEFT) + this.pp.ppFixLength(this.pp.ppPrice(sum_1), 10, prettyprinter_1.Align.RIGHT));
