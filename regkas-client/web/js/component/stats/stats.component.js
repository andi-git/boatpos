System.register(["angular2/core", "../../service/mode.service", "../../service/journal.service", "../../printer", "../../service/info.service"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, mode_service_1, journal_service_1, printer_1, info_service_1;
    var StatsComponent;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            StatsComponent = (function () {
                function StatsComponent(modeService, journalService, printer, infoService) {
                ...
                StatsComponent.prototype.incomeDay = function () {
                    ...
                    this.journalService.income(this.currentYear, this.convertMonth(this.currentMonth), this.currentDay).subscribe(function (income) { return _this.printer.printIncome(income); });
                };
                StatsComponent.prototype.incomeMonth = function () {
                    var _this = this;
                    this.infoService.event().emit("Einnahmen werden gedruckt.");
                    this.journalService.income(this.currentYear, this.convertMonth(this.currentMonth)).subscribe(function (income) { return _this.printer.printIncome(income); });
                };
                StatsComponent.prototype.incomeYear = function () {
                    var _this = this;
                    this.infoService.event().emit("Einnahmen werden gedruckt.");
                    this.journalService.income(this.currentYear).subscribe(function (income) { return _this.printer.printIncome(income); });
                };
                ...
                StatsComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [mode_service_1.ModeService, journal_service_1.JournalService, printer_1.Printer, info_service_1.InfoService])
                ], StatsComponent);
