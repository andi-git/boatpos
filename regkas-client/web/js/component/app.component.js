System.register(["angular2/core", "./../service/config.service", "angular2/http", "./info.component", "./../service/info.service", "./menu.component", "lib/angular2-modal", "./../modalHandler", "./../prettyprinter", "./../printer", "./../service/mode.service", "./version.component", "../service/keybinding.service", "./sale/numbers.component", "../service/sale.service", "./sale/actions.component", "../service/product.service", "./sale/products.component", "./sale/receipt.component", "../service/journal.service", "../service/error.service", "./stats/stats.component", "./config/config.component", "./signatureDevice.component"], function(exports_1, context_1) {
    ...
    var core_1, config_service_1, http_1, info_component_1, info_service_1, menu_component_1, angular2_modal_1, modalHandler_1, prettyprinter_1, printer_1, mode_service_1, version_component_1, keybinding_service_1, numbers_component_1, sale_service_1, actions_component_1, product_service_1, products_component_1, receipt_component_1, journal_service_1, error_service_1, stats_component_1, config_component_1, signatureDevice_component_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
            ...
            AppComponent = (function () {
                ...
                AppComponent = __decorate([
                    core_1.Component({
                        ...
                        directives: [info_component_1.InfoComponent, menu_component_1.MenuComponent, version_component_1.VersionComponent, numbers_component_1.NumbersComponent, actions_component_1.ActionsComponent, products_component_1.ProductComponent, receipt_component_1.ReceiptComponent, stats_component_1.StatsComponent, config_component_1.ConfigComponent, signatureDevice_component_1.SignatureDeviceComponent],
                        providers: [info_service_1.InfoService, error_service_1.ErrorService, http_1.HTTP_PROVIDERS, angular2_modal_1.Modal, keybinding_service_1.KeyBindingService, modalHandler_1.ModalHandler, prettyprinter_1.PrettyPrinter, printer_1.Printer, mode_service_1.ModeService, sale_service_1.SaleService, product_service_1.ProductService, config_service_1.ConfigService, journal_service_1.JournalService]
                    }), 
