...
import org.boatpos.common.repository.core.boat.BoatMapping;
...
public class MappingTest implements EntityManagerProvider {
    ...
    public void testGetMappedDtoClass() throws Exception {
        assertEquals(BoatBean.class, boatMapping.getMappedDtoClass());
    }

    @Test
    @Transactional
    public void testGetMappedEntityClass() throws Exception {
        assertEquals(BoatEntity.class, boatMapping.getMappedEntityClass());
    }
