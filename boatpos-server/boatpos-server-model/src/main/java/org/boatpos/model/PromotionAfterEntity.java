...
public class PromotionAfterEntity extends PromotionEntity {
    ...
    public PromotionAfterEntity(Long id, Integer version, String name, String priceCalculation, Set<RentalEntity> rentals, Integer priority, boolean enabled, Character keyBinding, String pictureUrl, String pictureUrlThumb) {
