...
public class PriceCalculatorTest {
    ...
    public void testCalculateDefault() throws Exception {
        ...
        assertEquals(new BigDecimal("20.33"), priceCalculated.get());
        ...
        assertEquals(new BigDecimal("27.33"), priceCalculated.get());
    ...
    public void testCalculateWithPromotionBefore() {
        ...
        assertEquals(new BigDecimal("0.33"), priceCalculated.get());
    ...
    public void testCalculateWithPromotionAfter() {
        ...
        assertEquals(new BigDecimal("13.84"), priceCalculated.get());
    }
