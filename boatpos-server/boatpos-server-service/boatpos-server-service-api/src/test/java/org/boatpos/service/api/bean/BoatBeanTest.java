...
public class BoatBeanTest extends JavaBeanTest<BoatBean> {
    ...
    public static BoatBean createBoatE() {
        return new BoatBean(1L, 1, "E-Boot", "E", new BigDecimal("16.8"), new BigDecimal("9.5"), new BigDecimal("14.3"), 22, 1, true);
    }

    public static BoatBean createBoatT() {
        return new BoatBean(2L, 1, "Tretboot klein", "T2", new BigDecimal("12.8"), new BigDecimal("7.5"), new BigDecimal("11.3"), 6, 2, true);
    }
}
