...
public class PromotionMappingTest {
    ...
    @Before
    public void before() {
        promotionBefore = new PromotionBeforeEntity(1L, 1, "PromoB", 60, "calcPrice", new HashSet<>(), 1, true);
        promotionBeforeBean = new PromotionBeforeBean(1L, 1, "PromoB", 60, "calcPrice", 1, true);
        promotionAfter = new PromotionAfterEntity(2L, 1, "PromoA", "calcPrice", new HashSet<>(), 1, true);
