...
public class SampleDatabaseCreator {
    ...
    public void fillDatabase(EntityManager em) {
        ...
        BoatEntity boat1 = new BoatEntity(null, 1, "E-Boot", "E", new BigDecimal("16.8"), new BigDecimal("9.5"), new BigDecimal("14.3"), 22, 1, new HashSet<>(), true, "http://www.eppel-boote.at/cms/images/stories/pics_eppel/boote/thumbs/eboot_2.jpg", "http://www.eppel-boote.at/cms/images/stories/pics_eppel/boote/eboot_2.jpg", "http://www.eppel-boote.at/cms/images/stories/pics_eppel/boote/eboot_2.jpg", 'a');
        BoatEntity boat2 = new BoatEntity(null, 1, "Tretboot klein", "T2", new BigDecimal("12.8"), new BigDecimal("7.5"), new BigDecimal("11.3"), 6, 2, new HashSet<>(), true, "http://www.eppel-boote.at/cms/images/stories/pics_eppel/boote/thumbs/tretboot_2.jpg", "http://www.eppel-boote.at/cms/images/stories/pics_eppel/boote/tretboot_2.jpg", "http://www.eppel-boote.at/cms/images/stories/pics_eppel/boote/tretboot_2.jpg", 'b');
        BoatEntity boat3 = new BoatEntity(null, 1, "Tretboot groß", "T4", new BigDecimal("12.8"), new BigDecimal("7.5"), new BigDecimal("11.3"), 9, 3, new HashSet<>(), true, "http://www.eppel-boote.at/cms/images/stories/pics_eppel/boote/thumbs/tretboot_4.jpg", "http://www.eppel-boote.at/cms/images/stories/pics_eppel/boote/tretboot_4.jpg", "http://www.eppel-boote.at/cms/images/stories/pics_eppel/boote/tretboot_4.jpg", 'c');
        ...
        BoatEntity boat5 = new BoatEntity(null, 1, "Liegeboot", "L", new BigDecimal("9.8"), new BigDecimal("9.8"), new BigDecimal("9.8"), 5, 5, new HashSet<>(), true, "http://www.eppel-boote.at/cms/images/stories/pics_eppel/boote/thumbs/ruderboot.jpg", "http://www.eppel-boote.at/cms/images/stories/pics_eppel/boote/ruderboot.jpg", "http://www.eppel-boote.at/cms/images/stories/pics_eppel/boote/ruderboot.jpg", 'e');
        BoatEntity boat6 = new BoatEntity(null, 1, "Pönt", "P", new BigDecimal("9.8"), new BigDecimal("9.8"), new BigDecimal("9.8"), 5, 6, new HashSet<>(), false, "http://www.eppel-boote.at/cms/images/stories/pics_eppel/boote/thumbs/ruderboot.jpg", "http://www.eppel-boote.at/cms/images/stories/pics_eppel/boote/ruderboot.jpg", "http://www.eppel-boote.at/cms/images/stories/pics_eppel/boote/ruderboot.jpg", 'f');
