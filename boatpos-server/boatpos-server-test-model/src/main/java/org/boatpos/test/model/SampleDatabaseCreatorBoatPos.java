...
@Dependent
public class SampleDatabaseCreatorBoatPos implements SampleDatabaseCreator {
    ...
    public void fillDatabase(EntityManager em) {
        ...
        PromotionEntity promotion1 = new PromotionBeforeEntity(null, 1, "Fahr 3 zahl 2", 180, "priceOneHour * 2", new HashSet<>(), 1, true, 'k', "", "http://www.eppel-boote.at/boatpos/images/promotion/3.png");
        PromotionEntity promotion2 = new PromotionBeforeEntity(null, 1, "Fahr 5 zahl 3", 300, "priceOneHour * 3", new HashSet<>(), 2, true, 'l', "", "http://www.eppel-boote.at/boatpos/images/promotion/5.png");
        ...
        CommitmentEntity commitment1 = new CommitmentEntity(null, 1, "Ausweis", true, new HashSet<>(), 1, true, 'A', "", "http://www.eppel-boote.at/boatpos/images/commitment/passport.png");
        CommitmentEntity commitment2 = new CommitmentEntity(null, 1, "EUR 50,-", false, new HashSet<>(), 2, true, 'B', "", "http://www.eppel-boote.at/boatpos/images/commitment/50.png");
        CommitmentEntity commitment3 = new CommitmentEntity(null, 1, "EUR 100,-", false, new HashSet<>(), 3, true, 'C', "", "http://www.eppel-boote.at/boatpos/images/commitment/100.png");
        CommitmentEntity commitment4 = new CommitmentEntity(null, 1, "Schlüssel", true, new HashSet<>(), 4, true, 'D', "", "http://www.eppel-boote.at/boatpos/images/commitment/key.png");
        CommitmentEntity commitment5 = new CommitmentEntity(null, 1, "Diverses", true, new HashSet<>(), 5, true, 'E', "", "http://www.eppel-boote.at/boatpos/images/commitment/questionmark.png");
        CommitmentEntity commitment6 = new CommitmentEntity(null, 1, "Kinderwagen", true, new HashSet<>(), 5, false, 'F', "", "http://www.eppel-boote.at/boatpos/images/blank_200x133.png");
        RentalEntity rental1 = new RentalEntity(null, 1, 1, LocalDate.of(2015, 7, 1), boat1, LocalDateTime.of(2015, 7, 1, 12, 00), LocalDateTime.of(2015, 7, 1, 14, 10), new BigDecimal("32.00"), new BigDecimal("1.60"), new BigDecimal("32.00"), new BigDecimal("1.60"), true, false, false, PaymentMethod.Card, PaymentMethod.Cash, promotion1, Sets.newHashSet(commitment1, commitment2));
        RentalEntity rental2 = new RentalEntity(null, 1, 2, LocalDate.of(2015, 7, 1), boat2, LocalDateTime.of(2015, 7, 1, 12, 14), null, null, null, null, null, false, true, false, null, null, null, Sets.newHashSet(commitment1));
        RentalEntity rental3 = new RentalEntity(null, 1, 3, LocalDate.of(2015, 7, 1), boat1, LocalDateTime.of(2015, 7, 1, 12, 15), null, null, null, null, null, false, false, false, null, null, null, Sets.newHashSet(commitment1));
        RentalEntity rental4 = new RentalEntity(null, 1, 4, LocalDate.of(2015, 7, 1), boat2, LocalDateTime.of(2015, 7, 1, 12, 20), null, null, null, null, null, false, false, false, null, null, null, null);
        RentalEntity rental5 = new RentalEntity(null, 1, 5, LocalDate.of(2015, 7, 1), boat3, LocalDateTime.of(2015, 7, 1, 12, 30), LocalDateTime.of(2015, 7, 1, 13, 37), null, new BigDecimal("12.60"), null, new BigDecimal("12.60"), true, false, false, null, PaymentMethod.Cash, null, Sets.newHashSet(commitment2));
        RentalEntity rental6 = new RentalEntity(null, 1, 6, LocalDate.of(2014, 7, 1), boat1, LocalDateTime.of(2014, 7, 1, 12, 00), LocalDateTime.of(2014, 7, 1, 13, 00), null, new BigDecimal("20.00"), null, new BigDecimal("20.00"), true, false, false, null, PaymentMethod.Cash, null, new HashSet<>());
        RentalEntity rental7 = new RentalEntity(null, 1, 6, LocalDate.of(2014, 7, 2), boat1, LocalDateTime.of(2014, 7, 2, 12, 00), LocalDateTime.of(2014, 7, 2, 13, 00), null, new BigDecimal("20.00"), null, new BigDecimal("20.00"), true, false, false, null, PaymentMethod.Card, null, new HashSet<>());
        RentalEntity rental8 = new RentalEntity(null, 1, 6, LocalDate.of(2015, 6, 1), boat1, LocalDateTime.of(2015, 6, 1, 12, 00), LocalDateTime.of(2015, 6, 1, 13, 00), null, new BigDecimal("20.00"), null, new BigDecimal("20.00"), true, false, false, null, PaymentMethod.Cash, null, new HashSet<>());
        RentalEntity rental9 = new RentalEntity(null, 1, 6, LocalDate.of(2015, 6, 1), boat1, LocalDateTime.of(2015, 6, 1, 13, 00), LocalDateTime.of(2015, 6, 1, 14, 00), null, new BigDecimal("20.00"), null, new BigDecimal("20.00"), true, false, false, null, PaymentMethod.Cash, null, new HashSet<>());
        RentalEntity rental10 = new RentalEntity(null, 1, 6, LocalDate.of(2015, 7, 31), boat1, LocalDateTime.of(2015, 7, 31, 12, 00), LocalDateTime.of(2015, 7, 31, 13, 00), null, new BigDecimal("20.00"), null, new BigDecimal("20.00"), true, false, false, null, PaymentMethod.Cash, null, new HashSet<>());
        RentalEntity rental11 = new RentalEntity(null, 1, 6, LocalDate.of(2015, 7, 31), boat1, LocalDateTime.of(2015, 7, 31, 13, 00), LocalDateTime.of(2015, 7, 31, 14, 00), null, new BigDecimal("20.00"), null, new BigDecimal("20.00"), true, false, false, null, PaymentMethod.Cash, null, new HashSet<>());
